...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        NotificationCompat.Action playPauseAction = new NotificationCompat.Action(
                ...
                MediaButtonReceiver.buildMediaButtonPendingIntent(this,
                        // creates a broadcast pending intent with a media button action.
                        // so we need to add a receiver in Manifest and create a broadcast receiver.
                        PlaybackStateCompat.ACTION_PLAY_PAUSE));
    ...
    // TODO (4): create a inner class Broadcast Receiver registered to receive the MEDIA_BUTTON intent coming from clients.
    /**
    ...
    public static class MediaReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            // make sure the intent is appropriately routed to the proper callback (MySessionCallback)
